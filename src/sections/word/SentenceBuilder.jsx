...
داستان_قفل_و_کلید: [
  {
    fa: ["یِک", "روز", "مَن", "و", "مادَر", "بیرون", "بودیم"],
    correctFa: ["یِک", "روز", "مَن", "و", "مادَر", "بیرون", "بودیم"],
    en: "One day my mom and I were outside"
  },
  {
    fa: ["ما", "می‌خواستیم", "واردِ", "خانِه", "شَویم"],
    correctFa: ["ما", "می‌خواستیم", "واردِ", "خانِه", "شَویم"],
    en: "We wanted to enter the house"
  },
  {
    fa: ["مادَر", "کِلید", "را", "دَر", "قُفل", "گُذاشت"],
    correctFa: ["مادَر", "کِلید", "را", "دَر", "قُفل", "گُذاشت"],
    en: "Mom put the key in the lock"
  },
  {
    fa: ["ناگَهان", "کِلید", "دَر", "قُفل", "شِکَست"],
    correctFa: ["ناگَهان", "کِلید", "دَر", "قُفل", "شِکَست"],
    en: "Suddenly the key broke in the lock"
  },
  {
    fa: ["دَر","را", "هَرچِه", "کِشیدیم", "باز", "نَشُد"],
    correctFa: ["دَر","را", "هَرچِه", "کِشیدیم", "باز", "نَشُد"],
    en: "No matter how we pulled, it didn’t open"
  },
  {
    fa: ["ما", "پُشتِ", "دَر", "گیر", "کَرده", "بودیم"],
    correctFa: ["ما", "پُشتِ", "دَر", "گیر", "کَرده", "بودیم"],
    en: "We were stuck behind the door"
  },
  {
    fa: ["مَن", "اَز", "مادَر", "پُرسیدَم", "چه", "کُنیم؟"],
    correctFa: ["مَن", "اَز", "مادَر", "پُرسیدَم", "چه", "کُنیم؟"],
    en: "I asked mom what to do"
  },
  {
    fa: ["مادَر", "آرام", "خَندید", "و", "نِگران", "نَبود"],
    correctFa: ["مادَر", "آرام", "خَندید", "و", "نِگران", "نَبود"],
    en: "Mom smiled calmly and wasn’t worried"
  },
  {
    fa: ["او", "گُفت", "قُفل‌ساز", "بایَد", "بیایَد"],
    correctFa: ["او", "گُفت", "قُفل‌ساز", "بایَد", "بیایَد"],
    en: "She said a locksmith must come"
  },
  {
    fa: ["کَمی", "بَعد", "قُفل‌ساز", "به", "خانِه", "آمد"],
    correctFa: ["کَمی", "بَعد", "قُفل‌ساز", "به", "خانِه", "آمد"],
    en: "After a while the locksmith came"
  },
  {
    fa: ["او", "کِلیدِ", "شِکَستِه", "را", "بیرون", "آوَرد"],
    correctFa: ["او", "کِلیدِ", "شِکَستِه", "را", "بیرون", "آوَرد"],
    en: "He took the broken key out"
  },
  {
    fa: ["قُفل‌ساز", "یِک", "قُفلِ", "تازِه", "ساخت"],
    correctFa: ["قُفل‌ساز", "یِک", "قُفلِ", "تازِه", "ساخت"],
    en: "The locksmith made a new lock"
  },
  {
    fa: ["او", "یِک", "کِلیدِ", "نو", "هَم", "داد"],
    correctFa: ["او", "یِک", "کِلیدِ", "نو", "هَم", "داد"],
    en: "He also gave a new key"
  },
  {
    fa: ["ما", "با", "خُوشحالی", "واردِ", "خانِه", "شُدیم"],
    correctFa: ["ما", "با", "خُوشحالی", "واردِ", "خانِه", "شُدیم"],
    en: "We happily went into the house"
  }
]
  };
